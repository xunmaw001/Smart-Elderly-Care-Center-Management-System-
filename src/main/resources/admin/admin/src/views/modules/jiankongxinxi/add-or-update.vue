<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="监控名称" prop="jiankongmingcheng">
					<el-input v-model="ruleForm.jiankongmingcheng" placeholder="监控名称" clearable  :readonly="ro.jiankongmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="监控名称" prop="jiankongmingcheng">
					<el-input v-model="ruleForm.jiankongmingcheng" placeholder="监控名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.jiankongfengmian" label="监控封面" prop="jiankongfengmian">
					<file-upload
						tip="点击上传监控封面"
						action="file/upload"
						:limit="3"
						:multiple="true"
						:fileUrls="ruleForm.jiankongfengmian?ruleForm.jiankongfengmian:''"
						@change="jiankongfengmianUploadChange"
					></file-upload>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.jiankongfengmian" label="监控封面" prop="jiankongfengmian">
					<img class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jiankongfengmian.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jiankongshipin" label="监控视频" prop="jiankongshipin">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"30px","background":"#93C7B3","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.jiankongshipin)">预览</el-button>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="监控说明" prop="jiankongshuoming">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.jiankongshuoming" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jiankongshuoming" label="监控说明" prop="jiankongshuoming">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jiankongshuoming"></span>
                </el-form-item>
...
export default {
	data() {
		...
		return {
			...
			ro:{
				jiankongmingcheng : false,
				jiankongfengmian : false,
				jiankongshipin : false,
				jiankongshijian : false,
				jiankongshuoming : false,
			},
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='jiankongmingcheng'){
							this.ruleForm.jiankongmingcheng = obj[o];
							this.ro.jiankongmingcheng = true;
							continue;
						}
						if(o=='jiankongfengmian'){
							this.ruleForm.jiankongfengmian = obj[o];
							this.ro.jiankongfengmian = true;
							continue;
						}
						if(o=='jiankongshipin'){
						...
						if(o=='jiankongshuoming'){
							this.ruleForm.jiankongshuoming = obj[o];
							this.ro.jiankongshuoming = true;
							continue;
						}
				}
	...
	this.ruleForm.jiankongshuoming = this.ruleForm.jiankongshuoming.replace(reg,'../../../springbootu1yrv/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.jiankongfengmian!=null) {
		this.ruleForm.jiankongfengmian = this.ruleForm.jiankongfengmian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    jiankongfengmianUploadChange(fileUrls) {
	this.ruleForm.jiankongfengmian = fileUrls;
    },
