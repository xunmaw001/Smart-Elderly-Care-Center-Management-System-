		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.zhaopian" label="照片" prop="zhaopian">
					<img class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhaopian.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="患病史" prop="huanbingshi">
					<el-input v-model="ruleForm.huanbingshi" placeholder="患病史" clearable  :readonly="ro.huanbingshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="患病史" prop="huanbingshi">
					<el-input v-model="ruleForm.huanbingshi" placeholder="患病史" readonly></el-input>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='huanbingshi'){
							this.ruleForm.huanbingshi = obj[o];
							this.ro.huanbingshi = true;
							continue;
						}
						if(o=='shenfenzheng'){
